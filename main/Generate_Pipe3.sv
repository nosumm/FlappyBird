...
module Generate_Pipe3(clock, reset, enable, light, gap_top, gap_size);
  ...
  output logic [15:0][15:0] light;
   ...
   logic [31:0][15:0] pipe; // 14 pipe positions 
	...
	assign pipe[0] [15:0] = 16'b000010000000000;
	assign pipe[1] [15:0] = 16'b000100000000000;
	assign pipe[3] [15:0] = 16'b001000000000000;
	assign pipe[7] [15:0] = 16'b010000000000000;
	assign pipe[14] [15:0] = 16'b100000000000000;
	assign pipe[13] [15:0] = 16'b000000000000001;
	assign pipe[11] [15:0] = 16'b000000000000010;
	assign pipe[6] [15:0] =  16'b000000000000100;
   assign pipe[12] [15:0] = 16'b000000000001000;
   assign pipe[9] [15:0] =  16'b000000000010000;
	
	assign pipe[2] [15:0] =  16'b0000000000100000;
	assign pipe[5] [15:0] =  16'b0000000001000000;
	assign pipe[10] [15:0] = 16'b0000000010000000;
	assign pipe[4] [15:0] =  16'b0000000100000000;
	assign pipe[8] [15:0] =  16'b0000001000000000;
	// no pipe
...
module Generate_Pipe3_testbench();
  logic clock, reset, enable;
  logic [15:0][15:0] light;
  logic [2:0] gap_top, gap_size;

  
  Generate_Pipe3 dut(.clock, .reset, .enable, .light, .gap_top, .gap_size);
