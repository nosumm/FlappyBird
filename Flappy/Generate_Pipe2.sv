...
module Generate_Pipe2(clock, reset, enable, light, gap_top, gap_size, pipe_code);
  
  input clock, reset, enable;
  input logic [2:0] gap_top, gap_size;
  
  output logic [15:0][15:0] light;
  output logic [3:0] pipe_code;
...
module Generate_Pipe2_testbench();
  logic clock, reset, enable;
  logic [15:0][15:0] light;
  logic [2:0] gap_top, gap_size;

  
  Generate_Pipe2 dut(.clock, .reset, .enable, .light, .gap_top, .gap_size);
